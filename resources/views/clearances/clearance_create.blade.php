        ...
        <div class="flex gap-5">
            ...
            <div class="w-full">
                <div class="flex justify-end gap-1.5 mb-3">
                    <a href="" class="border border-yellow-700 py-1 px-4 rounded text-xs bg-yellow-700 text-white font-medium hover:bg-yellow-800">ALL</a>
                    <a href="" class="border border-blue-700 py-1 px-4 rounded text-xs bg-blue-700 text-white font-medium hover:bg-blue-800">PENDING</a>
                    <a href="" class="border border-green-700 py-1 px-4 rounded text-xs bg-green-700 text-white font-medium hover:bg-green-800">APPROVED</a>
                    <a href="" class="border border-red-700 py-1 px-4 rounded text-xs bg-red-700 text-white font-medium hover:bg-red-800">CANCELED</a>
                </div>
