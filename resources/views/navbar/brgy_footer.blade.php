<footer class="w-full bg-red-800">
    <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div class="py-16 flex justify-between items-center flex-col gap-8 lg:flex-row">
            <a href="https://pagedone.io/" class="flex justify-center ">
                <img src="{{ asset('assets/image/brgy-logo.png') }}" alt="" class="w-38">
            </a>
            <ul
                ...
                <ul class="flex flex-col mt-4 font-medium lg:flex-row lg:space-x-8 lg:mt-0">
                    ...
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-100 border-b border-gray-100 hover:bg-red-900 lg:hover:bg-transparent lg:border-0 lg:hover:text-red-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">About
                            Us</a>
                    </li>
                    <li>
                        <a href="#"
                            class="block py-2 pl-3 pr-4 text-gray-100 border-b border-gray-100 hover:bg-red-900 lg:hover:bg-transparent lg:border-0 lg:hover:text-red-300 lg:p-0 dark:text-gray-400 lg:dark:hover:text-white dark:hover:bg-gray-700 dark:hover:text-white lg:dark:hover:bg-transparent dark:border-gray-700">Contact
                            Us</a>
                    </li>
                </ul>
            </ul>
        ...
        <div class="py-7 border-t border-gray-200">
            <div class="flex items-center justify-center">
                <span class="text-gray-100 ">©<a href="">Barangay@Kupal</a> 2025, All rights
                    reserved.</span>
            </div>
        </div>
    </div>
